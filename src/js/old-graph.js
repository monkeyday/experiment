...
function Text(p) {
  ...
  return React.createElement(
    'text',
    { x: d.x[0], y: d.y[0], dx: d.x[1], dy: d.y[1], fill: d.f, stroke: d.s, strokeWidth: d.b, strokeDasharray: d.d, strokeLinecap: d.l, opacity: d.o, transform: d.t, fontSize: d.fs },
    d.c
  );
}
...
function Round(p) {
  let s = p.s;
  let a = s.D.map((e, i) => React.createElement(Circle, { key: i, d: { x: p.xS(e.m_name), y: p.yS(e.avg_price), r: p.rS(e.amount), s: s.C[i % 20], f: p.color(e.amount), b: 1, o: 0.2 } }));
  return React.createElement(
    'g',
    null,
    a
  ...
  render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(Round, { s: this.state, xS: this.xS('m_name'), yS: this.yS('avg_price'), rS: this.rS('amount'), color: this.color('amount') })
      ),
      ...
      React.createElement(Text, { d: { x: [100, 5], y: [100, -5], f: 'blue', s: 'white', b: 1, d: '5,4', c: 'Hello', fs: 36, o: 0.5 } }),
      '/*',
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'div',
          { className: 'row', id: 'content', 'data-d': JSON.stringify(p.d) },
      ...
      React.createElement('script', { src: '/pub/js/graph.js' })
    )
  );
}
