...
function Point(p) {
  let d = p.d;
  console.log(d);
  return React.createElement('circle', { cx: d.x, cy: d.y, r: d.r, fill: d.f, stroke: d.s, strokeWidth: d.b });
}
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(Point, { d: { x: 150, y: 150, r: 1, f: 'black', s: 'black', b: 1 } }),
