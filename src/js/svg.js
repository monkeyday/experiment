...
module.exports = D => '<!DOCTYPE html>' + ReactDOMServer.renderToStaticMarkup(React.createElement(Root, { d: D }));
...
function Text(p) {
  ...
  return React.createElement(
    'text',
    { x: d.x, y: d.y, dx: d.dx, dy: d.dy, rotate: d.r, fill: d.f, stroke: d.s, strokeWidth: d.b, strokeDasharray: d.d, fontSize: d.fs, fontWeight: d.fw, textAnchor: d.a, opacity: d.o },
    d.t
  );
}
...
function Line(p) {
  //stroke-linecap: butt, round, square, stroke-dasharray: length, space, length, space,...
  let d = p.d;
...
function Rect(p) {
  let d = p.d;
  return React.createElement('rect', { x: d.x, y: d.y, width: d.w, height: d.h, fill: d.f, stroke: d.s, strokeWidth: d.b, strokeDasharray: d.d, opacity: d.o, fillOpacity: d.fo, strokeOpacity: d.so, transform: d.t });
}
...
function CRect(p) {
  ...
  let x = d.x - d.w / 2;
  let y = d.y - d.h / 2;
  return React.createElement(Rect, { d: { x: x, y: y, w: d.w, h: d.h, f: d.f, t: d.t, o: d.o } });
}

function RoundRect(p) {
  let d = p.d;
  return React.createElement('rect', { x: d.x[0], y: d.y[0], width: d.w, height: d.h, fill: d.f, stroke: d.s, strokeWidth: d.b, strokeDasharray: d.d, rx: d.x[1], ry: d.y[1], opacity: d.o, fillOpacity: d.fo, strokeOpacity: d.so, transform: d.t });
}
...
function Dot(p) {
  let d = p.d;
  return React.createElement('circle', { cx: d.x, cy: d.y, r: '1', fill: d.f, opacity: d.o });
}
...
function Polygon(p) {
  //fill-rule: nonzero, evenodd stroke-linejoin: miter, round, bevel
  let d = p.d;
  d.p.forEach(e => {
    e[0] = e[0] + d.x;
    e[1] = e[1] + d.y;
  ...
  return React.createElement('polygon', { points: pt, fill: d.f, fillRule: d.r, stroke: d.s, strokeWidth: d.b, strokeDasharray: d.d, opacity: d.o, onClick: p.evt, onDragEndCapture: p.evt });
}
...
function Polyline(p) {
  ...
  return React.createElement('polyline', { points: pt, fill: d.f, stroke: d.s, strokeWidth: d.b, strokeDasharray: d.d, opacity: d.o });
}
...
function Poly(p) {
  ...
  return React.createElement(Polygon, { d: { x: p.x, y: p.y, p: arr, f: 'url(#LG1)', r: 'nonzero', s: 'url(#RG1)', b: 3, d: '5,4', o: 0.3 } });
}
...
function Parallelogram(p) {
  ...
  return React.createElement(Polygon, { d: { x: 0, y: 0, p: a, f: 'url(#LG1)', r: 'nonzero', s: 'url(#RG1)', b: 3, d: '5,4', o: 0.3 } });
}
...
function Gradient(p) {
  ...
  let a = [];
  p.s.forEach((e, i) => a.push(React.createElement('stop', { key: i, offset: e.f, stopColor: e.c, stopOpacity: e.o })));
  if (p.t == 'l') {
    return React.createElement(
      'linearGradient',
      { id: p.id, x1: p.x1, x2: p.x2, y1: p.y1, y2: p.y2 },
      a
    );
  } else {
    return React.createElement(
      'radialGradient',
      { id: p.id, cx: p.x, cy: p.y, r: p.r, fx: p.fx, fy: p.fy },
      a
    );
  }
}
...
function Clip(p) {
  return React.createElement('clipPath', { id: p.id });
}

function Mask(p) {
  return React.createElement('mask', { id: p.id });
}
...
class SVG extends React.Component {
  ...
  render() {
    ...
    return React.createElement(
      'svg',
      { id: 'graph', width: this.state.G.W, height: this.state.G.H, style: { margin: this.state.G.M, padding: this.state.G.P }, version: '1.1', xmlns: 'http://www.w3.org/2000/svg' },
      React.createElement(
        'defs',
        null,
        React.createElement(Gradient, { id: 'RG1', t: 'r', s: [{ f: '0%', c: 'green' }, { f: '30%', c: 'yellow' }, { f: '60%', c: 'orange' }, { f: '100%', c: 'purple', o: 0.5 }] }),
        React.createElement(Gradient, { id: 'LG1', t: 'l', s: [{ f: '0%', c: 'green' }, { f: '30%', c: 'yellow' }, { f: '60%', c: 'orange' }, { f: '100%', c: 'purple', o: 0.5 }] })
      ),
      React.createElement(
        'g',
        null,
        ...
        React.createElement(Dot, { d: { x: 150 + this.state.X, y: 150 + this.state.Y, f: 'black', o: 1 } }),
      ...
      React.createElement(Parallelogram, { x: 300, y: 300, a: 160, w: 50, h: 15 }),
      React.createElement(Poly, { i: 7, R: 50, x: 300, y: 300 }),
      React.createElement(Triangle, { x: 300, y: 300, a: 15, s: 1, w: 150 }),
      React.createElement(Position, { i: 8, s: 20, R: 100, x: 300, y: 300, w: 100, h: 80, r: 15, t: Triangle, a: 15, ss: 110, f: 'url(#RG1)' }),
      React.createElement(Ellipse, { d: { x: [200, 30], y: [200, 20], f: 'url(#RG1)', s: 'white', d: '5,4', o: 0.5 } }),
      React.createElement(Dot, { d: { x: 150, y: 150, r: 1, f: 'black', s: 'black', b: 1 } }),
      React.createElement(RoundRect, { d: { x: [this.state.X, 10], y: [this.state.Y, 10], w: 50, h: 50, f: 'pink', t: 'rotate(10 20,40)' } }),
      React.createElement(CRect, { d: { x: 300, y: 300, w: 50, h: 50, f: 'pink', t: 'rotate(10 20,40)', o: 0.3 } }),
      React.createElement(Polygon, { d: { x: this.state.X, y: this.state.Y, p: [[100, 120], [75, 130], [100, 250], [200, 250], [300, 150], [175, 200]], f: 'url(#LG1)', r: 'nonzero', s: 'url(#RG1)', b: 3, d: '5,4', o: 0.3 }, evt: this.evt }),
      React.createElement(Polyline, { d: { x: this.state.X, y: this.state.Y, p: [[50, 150], [150, 250], [250, 50], [200, 100]], f: 'none', s: 'brown', b: 2, d: '5,4', o: 0.3 } }),
      React.createElement(Text, { d: { x: [100, 5], y: [100, -5], f: 'blue', s: 'white', b: 3, d: '5,4', t: 'Hello', fs: 36, o: 0.5 } }),
      React.createElement(Path, path),
      React.createElement('path', { d: 'M100 100 C 80 200, 270 200, 250 100 S 420 0, 400 100, 570 200, 550 100', fill: 'transparent', stroke: 'orange', strokeWidth: 3 }),
...
function Root(p) {
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement('script', { src: '/pub/js/svg.js' }),
      React.createElement('script', { src: '/pub/js/jquery-ui.min.js' })
    )
  );
}
...
if (this.document) {
  ...
  ReactDOM.render(React.createElement(SVG, { d: JSON.parse(e.dataset.d) }), e);
